...
if __name__ == "__main__":
    ...
    # Handling Parameters
    if len(sys.argv) > 2:
        validatePlot("../data/kdd17/numerical/price_long_50/" + sys.argv[1] + ".csv", sys.argv[1], "Adj Close")
        validatePlot("../data/stocknet/numerical/price_long_50/" + sys.argv[2] + ".csv", sys.argv[2], "Adj Close")
    elif len(sys.argv) > 1:
